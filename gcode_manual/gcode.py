...
from bosdyn.api import (arm_surface_contact_pb2, arm_surface_contact_service_pb2,
                        basic_command_pb2, geometry_pb2, trajectory_pb2)
...
class GcodeReader:
    ...
    def get_vision_T_goal(self, origin_T_goal, ground_plane_rt_vision):
        if not self.draw_on_wall:
            ...
            goal2 = SE3Pose(origin_T_goal.x, origin_T_goal.y,
                            origin_T_goal.z + z_offset, origin_T_goal.rot)
...
def run(initial_gcode_file, test_only=False):
    ...
    def _draw_file(gcode_file, preview_corners=True):
        ...
        odom_T_ground = get_a_tform_b(robot_state.kinematic_state.transforms_snapshot,
